...
hl.bind(
	mainMod .. " + SHIFT + S",
	hl.dsp.exec_cmd(
		[[mkdir -p ~/Pictures/Screenshots && grim -g "$(slurp)" - | tee ~/Pictures/Screenshots/$(date +%Y%m%d_%H%M%S).png | wl-copy && notify-send -a "grim" -i "camera-photo" 'Screenshot' 'Saved to ~/Pictures/Screenshots & copied to clipboard']]
	)
)
...
hl.bind(
	mainMod .. " + F1",
	hl.dsp.exec_cmd(
		[[powerprofilesctl set power-saver && notify-send "power profile daemon" "Switch to power-server" ]]
	)
)
hl.bind(
	mainMod .. " + F2",
	hl.dsp.exec_cmd([[powerprofilesctl set balanced && notify-send "power profile daemon" "Switch to balanced" ]])
)
hl.bind(
	mainMod .. " + F3",
	hl.dsp.exec_cmd([[powerprofilesctl set performance && notify-send "power profile daemon" "Switch to performance" ]])
)
...
-- Laptop multimedia keys untuk volume dan LCD brightness
hl.bind(
